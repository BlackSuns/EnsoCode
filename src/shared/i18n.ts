...
export const zhTranslations: Record<string, string> = {
  ...
  'Accent color': '强调色',
  'Highlight color used across the interface': '界面高亮使用的颜色',
  Violet: '紫罗兰',
  Indigo: '靛蓝',
  Teal: '青绿',
  Amber: '琥珀',
  ...
  'Search conversations, browser tabs, settings…': '搜索对话、浏览器标签、设置…',
  'Search all projects': '搜索全部项目',
  'Switch scope': '切换范围',
  Navigate: '选择',
  Open: '打开',
  ...
  'Edit group': '编辑分组',
  'All groups': '全部分组',
  'Add project or group': '添加项目或分组',
  'Search in {{group}}...': '在「{{group}}」中搜索...',
  'Delete group': '删除分组',
  'No color': '无颜色',
  'Project group': '项目组',
  Alias: '别名',
  ...
  'No custom workflow presets yet': '还没有自定义工作流预设',
  ...
  'Click a node to edit it. Steps in a column run in parallel; columns run from left to right.':
    '点击节点即可编辑。同一列的步骤并行执行，各列从左到右依次执行。',
  Start: '开始',
  'No arguments': '无参数',
  'Last phase output': '末阶段输出',
  'Untitled phase': '未命名阶段',
  'Untitled step': '未命名步骤',
  'No prompt yet': '尚未填写提示词',
  'Parallel step': '并行步骤',
  'Insert phase here': '在此插入阶段',
  'Phase {{n}} · Step {{m}}': '阶段 {{n}} · 步骤 {{m}}',
  'Move left': '左移',
  'Move right': '右移',
  ...
  'Task output': '查看后台任务',
  'Task stop': '停止后台任务',
  'Message coworker': '联系队员',
  'Message main agent': '联系主 agent',
  'Enso app': 'Enso 应用',
  'Enso capabilities': 'Enso 能力',
  'Recall memory': '回溯记忆',
  'Memory search': '搜索记忆',
  'Memory capture': '记录记忆',
  ...
  'Browser type': '浏览器 · 输入',
  'Browser tabs': '浏览器 · 标签页',
  'Browser lock': '浏览器 · 锁定',
  'Browser fill': '浏览器 · 填写',
  'Browser press key': '浏览器 · 按键',
  'Browser scroll': '浏览器 · 滚动',
  'Browser select option': '浏览器 · 选择选项',
  'Browser click xy': '浏览器 · 坐标点击',
  'Browser drag': '浏览器 · 拖拽',
  'Browser highlight': '浏览器 · 高亮',
  'Browser bounding box': '浏览器 · 元素位置',
  'Browser screenshot': '浏览器 · 截图',
  'Browser CDP': '浏览器 · CDP',
